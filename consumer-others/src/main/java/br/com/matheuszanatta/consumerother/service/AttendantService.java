package br.com.matheuszanatta.consumerother.service;
...
public class AttendantService {
    ...
    public AttendantService() {
        attendants.add(new Attendant("João", Theme.OTHERS, 0));
        attendants.add(new Attendant("Jana", Theme.OTHERS, 0));
        attendants.add(new Attendant("Joaquim", Theme.OTHERS, 0));
    }
